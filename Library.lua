...
local Autostrat = Window:Tab({Title = "Autostrat", Icon = "star"}) do
    ...
    Autostrat:Section({Title = "Target Visual"})
    Autostrat:Dropdown({
    ...
    Autostrat:Section({Title = "Auto Gatling Gun"})
    ...
    Autostrat:Textbox({ Title = "Auto Cooldown:", Placeholder = "0.01", Value = tostring(Globals.AutoCooldown), ClearTextOnFocus = true, Callback = function(value) if tonumber(value) then Globals.AutoCooldown = tonumber(value); SetSetting("AutoCooldown", tonumber(value)) end end })
    Autostrat:Textbox({ Title = "Auto Multiply:", Placeholder = "1", Value = tostring(Globals.AutoMultiply), ClearTextOnFocus = true, Callback = function(value) if tonumber(value) then Globals.AutoMultiply = tonumber(value); SetSetting("AutoMultiply", tonumber(value)) end end })
    ...
    Autostrat:Section({Title = "Gatling Gun (Silent Aim)"})
    ...
    Autostrat:Textbox({ Title = "Cooldown:", Placeholder = "0.01", Value = tostring(Globals.Cooldown), ClearTextOnFocus = true, Callback = function(value) local num = tonumber(value); if num then SetSetting("Cooldown", num) end end })
    Autostrat:Textbox({ Title = "Multiply:", Placeholder = "1", Value = tostring(Globals.Multiply), ClearTextOnFocus = true, Callback = function(value) local num = tonumber(value); if num then SetSetting("Multiply", num) end end })

    Autostrat:Button({ Title = "Apply Gatling", Callback = function() Globals.CustomGatlingApplied = true; local hooked = EnsureGatlingHook(); if hooked then Window:Notify({ Title = "ADS", Desc = "Successfully applied Custom Cooldown & Multiply!", Time = 3, Type = "normal" }) else Window:Notify({ Title = "Error", Desc = "Equip Gatling Gun first!", Time = 3, Type = "error" }) end end })
    Autostrat:Button({ Title = "Reset Gatling", Callback = function() Globals.CustomGatlingApplied = false; Window:Notify({ Title = "ADS", Desc = "Gatling speed & multiply reset to normal!", Time = 3, Type = "normal" }) end })
